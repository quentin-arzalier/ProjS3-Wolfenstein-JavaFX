...
public class MainApp extends Application {
    ...
    // L'ensemble des touches enfoncées
    private Set<KeyCode> pressedKeys = new HashSet<>();
    private Minimap minimap;

    private final InvalidationListener whenPlayerAmountSet = change -> startGame();
    private final KeyCode[] levelKeys = {KeyCode.NUMPAD0, KeyCode.NUMPAD1, KeyCode.NUMPAD2, KeyCode.NUMPAD3, KeyCode.NUMPAD4, KeyCode.NUMPAD5};
     ...
     * Attention : Cette méthode ne fonctionne pas avec le mode multi-joueur.
     *
